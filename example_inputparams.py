...
def parse_halotest_args():
    ...
    parser.add_argument('--hires',type=int,default=80,help='cell resolution')
    parser.add_argument('--lores',type=int,default=20,help='cell resolution')
    parser.add_argument('--boxlen',type=int,default=40,help='cell resolution')
